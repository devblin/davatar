...
class Davatar {
	generate({
		...
		const checkTextColorResult = checkTextColor(textColor);
		const checkBackgroundColorResult = checkBackgroundColor(backgroundColor);
		
		if (checkSize && checkText && checkTextColorResult && checkBackgroundColorResult) {
